 ...
 */
const CALLOUT_PATTERN = /^> \[!\w+\] (?:User|Gemini|Claude|ChatGPT|Perplexity|Assistant)\b/gm;

/**
 * Pattern matching blockquote/plain format: **Label:**
 * Labels: User, Gemini, Claude, ChatGPT, Perplexity, Assistant
 */
const LABEL_PATTERN = /^\*\*(?:User|Gemini|Claude|ChatGPT|Perplexity|Assistant):\*\*/gm;
...
const MESSAGE_START_PATTERN =
  /^(?:> \[!\w+\] (?:User|Gemini|Claude|ChatGPT|Perplexity|Assistant)\b|\*\*(?:User|Gemini|Claude|ChatGPT|Perplexity|Assistant):\*\*)/;
